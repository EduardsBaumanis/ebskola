...
| `topic1_create_node.png` | 1.4 Add Child Node with custom `Hello` class | `https://docs.godotengine.org/en/stable/_images/globalclasses_addnode.webp` | Shows a custom class, but not `Hello` exactly |
